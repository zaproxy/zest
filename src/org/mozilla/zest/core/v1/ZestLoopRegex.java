...
/**
 * This class represent a loop through a list of regex matches for the given variable and pattern
 * a file.
 */
public class ZestLoopRegex extends ZestLoop<String> {
	...
	public ZestLoopRegex(String variableName, String inputVariableName, String regex, int groupIndex, boolean caseExact) {
		super(variableName);
