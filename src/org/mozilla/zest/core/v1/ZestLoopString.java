...
public class ZestLoopString extends ZestLoop<String> {
	...
	public ZestLoopString(String name, String[] values) {
		super(name, new ZestLoopTokenStringSet(values),
	...
	public ZestLoopString(String[] values) {
		super(new ZestLoopTokenStringSet(values),
				new LinkedList<ZestStatement>());
	}
	...
	public ZestLoopString(int index) {
		super(index, new ZestLoopTokenStringSet(),
				new LinkedList<ZestStatement>());
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mozilla.zest.core.v1.ZestLoop#setSet(org.mozilla.zest.core.v1.
	 * ZestLoopTokenSet)
	 */
	@Override
