...
public class TestSerializationScriptWithLoop {
	public static void main(String[] args) throws FileNotFoundException{
		...
		ZestScript script=new ZestScript("TestSerializationZestScript", "Just to test the correct serialization", Type.StandAlone);
		script.add(loop);
		System.out.println("========================");
...
//		ZestScript script2=new ZestScript("TestSerializationZestScript2", "Just to test the correct serialization", Type.StandAlone);
