...
public class ZestAssignFromElementTest {
    ...
    private final String htmlScaffold = "<html><head><title>Test Document</title></head><body>" +
                                        "<div>" +
                                        "%s" +
                                        "</div>" +
                                        "</body></html>";

    private final String testPageA =    "<ul class=\"customA\">\n" +
    ...
    private final String testPageB =    "<nav>\n"+
                                         "  <ul>\n"+
    ...
    public void selectClassAttributeOfLastElement() throws Exception {
        // Given
        ZestAssignFromElement fromElement = new ZestAssignFromElement("Var")
                .last()
    ...
    public void testSerialization() {
        ...
        assertEquals(fromElement.getReturnedAttributeName(), fromElement2.getReturnedAttributeName());
        assertEquals(fromElement.getAttributeValueFilterFlags(), fromElement2.getAttributeValueFilterFlags());
        assertEquals(fromElement.getElementIndex(), fromElement2.getElementIndex());
        assertEquals(fromElement.areFilteredElementsReversed(), fromElement2.areFilteredElementsReversed());
    ...
    private String assign(ZestAssignFromElement assignFromElement, String pageContent) throws ZestAssignFailException {
