...
public class ZestAssertBodyRegexUnitTest {
	...
	public void testSimpleIncRegex() throws Exception {
		...
		ze.setRegex("test123");
		assertTrue(ze.isValid(new ZestResponse("", "aaaatest123", 200)));
	}
	...
	public void testSimpleExcRegex() throws Exception {
		ZestAssertBodyRegex ze = new ZestAssertBodyRegex();
		ze.setRegex("test123");
		assertFalse(ze.isValid(new ZestResponse("", "aaaatst123", 200)));
	}
	...
	public void testSimpleIncInvRegex() throws Exception {
		...
		ze.setRegex("test123");
		ze.setInverse(true);
		assertFalse(ze.isValid(new ZestResponse("", "aaaatest123", 200)));
	}
	...
	public void testSimpleExcInvRegex() throws Exception {
		...
		ze.setRegex("test123");
		ze.setInverse(true);
		assertTrue(ze.isValid(new ZestResponse("", "aaaatst123", 200)));
	}
