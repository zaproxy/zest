...
public class ZestLoopStringUnitTest {
	...
	public void testZestLoopStringStringArrayIntListOfZestStatement() {
		...
		boolean rightStmtPos=loop.getStatement(firstIndex).getClass().equals(ZestLoopString.class);
		ZestLoopStateString state=(ZestLoopStateString) loop.getCurrentState();
	...
	public void testEndLoop() {
		ZestLoopString loop=new ZestLoopString(0,values, new LinkedList<ZestStatement>());
		loop.endLoop();
