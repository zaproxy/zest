...
public class ZestScriptUnitTest {
	...
	public void testDeepMiscOrder() throws Exception {
		...
		zc2.addElse(req6);
		checkOrder(new ZestStatement[]{script, req5, zc2, req6, req1, zc1, req4, req3, req2, null});
		
		zc2.addElse(zc3);
		checkOrder(new ZestStatement[]{script, req5, zc2, req6, zc3, req1, zc1, req4, req3, req2, null});
		
		zc2.addIf(req7);
		checkOrder(new ZestStatement[]{script, req5, zc2, req7, req6, zc3, req1, zc1, req4, req3, req2, null});
